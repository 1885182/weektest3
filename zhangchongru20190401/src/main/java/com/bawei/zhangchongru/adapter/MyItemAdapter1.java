 ...
 * @Description:
 */
public class MyItemAdapter1 extends RecyclerView.Adapter<MyItemAdapter1.ViewHolder> {
    List<Shop> list;
    Context context;

    public MyItemAdapter1(List<Shop> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_item2,null);
